...
//		}
	...
	function renderTmpl(data, context, parentView, key, isLayout, onRender) {
...
//		render: function(val) {
//			var self = this;
//			return (self._done || arguments.length && !val) ? "" : (self._done = true, self.renderTmpl());
//		}
//	},
